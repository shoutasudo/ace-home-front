                        ...
                        <table className="table-auto w-full flex justify-center items-center ">
                            <tbody className='w-full'>
                                ...
                                <tr className="flex flex-col sm:flex-row items-center">
                                    ...
                                    <td className='border border-t-0 border-gray-300 bg-white px-4 py-2 w-full sm:w-2/3 text-center text-sm text-fontMainBrown'>兵庫県神戸市長田区長田町５丁目３番２号　崎谷ビル２階</td>
                                </tr>
                                <tr className="flex flex-col sm:flex-row items-center">
                                    <th className='bg-mainPink text-white font-bold text-center w-full sm:w-1/3 min-w-4 border-t-0 border-l border-b border-gray-300 px-4 py-2 text-sm'>電話番号</th>
