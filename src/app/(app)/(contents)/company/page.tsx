                        ...
                        <table className="table-auto w-full flex justify-center items-center ">
                            <tbody className='w-full'>
                                <tr className="flex flex-col sm:flex-row items-center">
                                    ...
                                    <td className='border border-gray-300 bg-white px-4 py-2 w-full sm:w-2/3 text-center text-fontMainBrown'>株式会社ACE HOME</td>
                                </tr>
                                <tr className="flex flex-col sm:flex-row items-center">
                                ...
                                <tr className="flex flex-col sm:flex-row items-center">
                                    ...
                                    <td className='border border-t-0 border-gray-300 bg-white px-4 py-2 w-full sm:w-2/3 text-center text-fontMainBrown'>078-611-6007</td>
                                </tr>
                                <tr className="flex flex-col sm:flex-row items-center">
                                    ...
                                    <td className='border border-t-0 border-gray-300 bg-white px-4 py-2 w-full sm:w-2/3 text-center text-fontMainBrown'>2024年5月</td>
                                </tr>
                                <tr className="flex flex-col sm:flex-row items-center">
